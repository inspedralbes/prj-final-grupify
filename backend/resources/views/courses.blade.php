...
<div class="container py-4">
        ...
        <div class="card-body p-0">
            <div class="p-4 bg-gradient-primary text-white" style="background: linear-gradient(135deg, #00ADEE 0%, #0078A0 100%);">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    <div>
                        <h1 class="h2 mb-2 fw-bold">Gestió de Cursos</h1>
                        <p class="mb-0 opacity-75">Administra els cursos acadèmics del centre</p>
                    </div>
    ...
    <div class="row g-4">
        <!-- Versión para escritorio: Tabla de cursos -->
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm d-none d-md-block">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    @if(!isset($_GET['edit']))
                    <a href="{{ route('courses.index', ['new' => true]) }}" class="btn btn-primary rounded-pill px-4 d-inline-flex align-items-center">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="{{ route('courses.index', ['edit' => $course->id]) }}" 
                                                   class="btn btn-sm btn-outline-warning rounded-pill px-3" title="Editar curs">
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center py-5">
                                            <div class="d-flex flex-column align-items-center py-4">
                                                <i class="fas fa-graduation-cap text-muted mb-3" style="font-size: 3rem; opacity: 0.3;"></i>
                                                <h5 class="fw-light text-muted">No s'han trobat cursos</h5>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
            ...
            <!-- Versión para móviles: Tarjetas de cursos -->
            <div class="d-md-none">
                @forelse($courses as $course)
                <div class="card border-0 shadow-sm mb-3 course-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="card-title mb-0 d-flex align-items-center">
                                <span class="course-id me-2">{{ $course->id }}</span>
                                {{ $course->name }}
                            </h5>
                        </div>

                        <div class="d-flex justify-content-end gap-2 mt-3 pt-3 border-top">
                            <a href="{{ route('courses.index', ['edit' => $course->id]) }}" class="btn btn-outline-warning">
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0">
                        ...
                        {{ isset($_GET['edit']) ? 'Editar Curs' : 'Nou Curs' }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ isset($_GET['edit']) ? route('courses.update', $_GET['edit']) : route('courses.store') }}" 
                        ...
                        <div class="mb-4">
                            <label for="name" class="form-label fw-semibold">Nom del Curs</label>
                            ...
                            <div class="form-text">Per exemple: "ESO 1r", "Batxillerat 2n", etc.</div>
                        </div>

                        <div class="d-grid gap-2 mt-4">
                            <button type="submit" class="btn btn-primary py-2">
                                <i class="fas fa-save me-2"></i>
                                {{ isset($_GET['edit']) ? 'Actualitzar Curs' : 'Crear Curs' }}
                            </button>

                            <a href="{{ route('courses.index') }}" class="btn btn-outline-secondary py-2">
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex flex-column justify-content-center align-items-center py-5 text-center">
                    <div class="mb-4">
                        <i class="fas fa-graduation-cap" style="font-size: 3rem; color: #00ADEE;"></i>
                    </div>
                    <h4 class="mb-3">Gestiona els Cursos</h4>
                    <p class="text-muted mb-4">Els cursos representen els nivells acadèmics del centre educatiu.</p>
                    <a href="{{ route('courses.index', ['new' => true]) }}" class="btn btn-primary rounded-pill px-4 d-inline-flex align-items-center">
                        <i class="fas fa-plus-circle me-2"></i>
                        Afegir Nou Curs
                    </a>
