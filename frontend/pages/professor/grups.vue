          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <textarea v-model="groupDescription" placeholder="Descripció (opcional)" rows="4"
                class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"></textarea>
            </div>
          </div>
                ...
                <li v-for="student in students" :key="student.id"
                  ...
                  <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" :value="student.id" :checked="selectedStudents.includes(student.id)"
                      @change="toggleSelection(student.id)" class="sr-only peer" />
                    <div
      ...
      <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow mt-12 mb-12">
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
          <div class="flex justify-between gap-4">
            ...
            <button @click="handleCreateGroup" :disabled="!groupName || selectedStudents.length === 0 || isLoading"
