...
const groups = ref([]); // Estado para almacenar los grupos

// Llamar a la API para obtener los estudiantes
onMounted(() => {
  studentsStore.fetchStudents(); // Obtiene los estudiantes
  fetchGroups(); // Obtiene los grupos
});
...
const handleCreateGroup = async () => {
  ...
  try {
    ...
    fetchGroups(); // Actualiza los grupos tras crear uno nuevo
